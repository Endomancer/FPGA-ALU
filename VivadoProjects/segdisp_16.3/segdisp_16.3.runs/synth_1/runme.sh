...
HD_PWD='C:/Users/endop/OneDrive/Documents/ENEL373Labs/segdisp_16.3/segdisp_16.3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SegDisp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SegDisp.tcl
